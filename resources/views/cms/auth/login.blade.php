            ...
            <form class="m-t" role="form" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <div class="checkbox i-checks">
                        <label> <input type="checkbox" name="remember" value="1" {{ old('remember') ? 'checked' : '' }}><i></i>
                ...
                <a class="btn btn-sm btn-white btn-block" href="{{ route('cms.register') }}">Create an account</a>
            </form>
            <p class="m-t">
